...
object Const {
    ...
    const val PREF_NOTIFICATIONS_NEWS = "NOTIFICATIONS_NEWS"
    const val PREF_NOTIFICATIONS_MSG = "NOTIFICATIONS_MSG"
    const val PREF_NOTIFICATIONS_MATCHES = "NOTIFICATIONS_MATCHES"
    const val PREF_ACTIVITY_TRACKING = "ACTIVITY_TRACKING"
    const val PREF_SYNC_WITH_DATA = "SYNC_WITH_DATA"
