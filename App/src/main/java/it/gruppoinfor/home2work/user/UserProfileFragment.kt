...
/*        chart_activity.setOnChartValueSelectedListener(object : OnChartValueSelectedListener {
    ...
    private fun refreshActivityUI() {
        ...
        if (stats.sharedDistance > 0) {
            ...
            avgDataSet.fillDrawable = ContextCompat.getDrawable(context!!, R.drawable.drawable_activity_chart_avg_fill)
            ...
            activityDataSet.fillDrawable = ContextCompat.getDrawable(context!!, R.drawable.drawable_activity_chart_fill)
