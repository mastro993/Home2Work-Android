...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initUI() {
        ...
        // Navigation
        AHBottomNavigationItem homeTab = new AHBottomNavigationItem(R.string.activity_main_tab_home, R.drawable.ic_home, R.color.colorPrimaryDark);
        AHBottomNavigationItem matchTab = new AHBottomNavigationItem(R.string.activity_main_tab_matches, R.drawable.ic_match, R.color.colorPrimary);
        AHBottomNavigationItem sharesTab = new AHBottomNavigationItem(R.string.activity_main_tab_shares, R.drawable.ic_car_side, R.color.light_blue_300);
        AHBottomNavigationItem profileTab = new AHBottomNavigationItem(R.string.activity_main_tab_profile, R.drawable.ic_user, R.color.colorAccent);
