...
import it.gruppoinfor.home2work.views.AppBarStateChangeListener
...
class UserActivity : AppCompatActivity(), UserView {
    ...
    override fun setProfileData(userProfile: Profile) {
        ...
        if (stats.sharedDistance > 0) {
            ...
            for (i in 5 downTo 0) {
                ...
                val activity = userProfile.activity[month + 1 ]
