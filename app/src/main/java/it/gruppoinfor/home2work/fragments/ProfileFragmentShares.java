 ...
 */
public class ProfileFragmentShares extends Fragment implements ItemClickCallbacks {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_profile_shares, container, false);
    ...
    private void initUI() {
        ...
        for (Share share : ProfileFragment.ShareList)
